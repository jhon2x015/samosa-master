...
config(['$routeProvider', function ($routeProvider) {
	...
	$routeProvider.when('/Viewstudent/:id', {templateUrl: 'partials/super_admin/viewstudent.html'});
	$routeProvider.when('/Viewhousingass/:id', {templateUrl: 'partials/super_admin/viewhousigass.html'});

	$routeProvider.when('/Adminstudent', {templateUrl: 'partials/super_admin/adminStudent.html'});
	$routeProvider.when('/Addstudent', {templateUrl: 'partials/super_admin/addStudent.html'});
	...
	$routeProvider.when('/Editstudent/:id', {templateUrl: 'partials/super_admin/editstudent.html'});
    ...
    $routeProvider.when('/Student/:id', {templateUrl: 'partials/student.html'});
