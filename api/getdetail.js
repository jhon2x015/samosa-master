...
// exports.municipalitydetail = function(req, res) {
 ...
 exports.studentdetail = function(req, res) {
  var id=parseInt(req.params.id);
       var query = "SELECT tbl_student.stud_id , tbl_student.stud_name ,  tbl_state.state_name FROM tbl_student INNER JOIN tbl_state ON tbl_student.state_id = tbl_state.state_id where  tbl_student.stud_id="+id;
